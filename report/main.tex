...
\textbf{Off-chain} - Something that is not on the blockchain.\\
...
is the singular node formed at the top of the tree. The tree makes it easier to check if an element is part of the list without sending the entire list.\\
