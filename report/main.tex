...
\textbf{Onchain} - Something that is onchain (for example a transaction) has been included in the blockchain and can be safely assumed to be immutable, in other words can not be changed.\\
